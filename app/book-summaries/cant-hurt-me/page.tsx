...
export default function CantHurtMeSummaryPage() {
  const [isBookmarked, setIsBookmarked] = useState(false);
  const bookmarkId = "doc-cant-hurt-me";
  const docTitle = "Can't Hurt Me Summary";
  ...
  const handleBookmarkToggle = () => {
    ...
    if (isBookmarked) {
      ...
      updated = [
        { id: bookmarkId, label: docTitle, href: "/book-summaries/cant-hurt-me", lastRead: Date.now() },
        ...bookmarks,
      ];
    }
    localStorage.setItem("colloque_bookmarks", JSON.stringify(updated));
  ...
  return (
    <div style={{ position: "relative", width: "100%", height: "100vh" }}>
      <iframe
        ...
        title="Can't Hurt Me — Full Summary"
      />
      <button
