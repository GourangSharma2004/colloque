...
export default function CrushItSummaryPage() {
  const [isBookmarked, setIsBookmarked] = useState(false);
  const bookmarkId = "doc-crush-it";
  const docTitle = "CRUSH IT! Summary";
  ...
  const handleBookmarkToggle = () => {
    ...
    if (isBookmarked) {
      ...
      updated = [
        { id: bookmarkId, label: docTitle, href: "/book-summaries/crush-it", lastRead: Date.now() },
        ...bookmarks,
      ];
    }
    localStorage.setItem("colloque_bookmarks", JSON.stringify(updated));
