...
export default function DopamineNationSummaryPage() {
  const [isBookmarked, setIsBookmarked] = useState(false);
  const bookmarkId = "doc-dopamine-nation";
  const docTitle = "Dopamine Nation Summary";
  ...
  const handleBookmarkToggle = () => {
    ...
    if (isBookmarked) {
      ...
      updated = [
        { id: bookmarkId, label: docTitle, href: "/book-summaries/dopamine-nation", lastRead: Date.now() },
        ...bookmarks,
      ];
    }
    localStorage.setItem("colloque_bookmarks", JSON.stringify(updated));
  ...
  return (
    <div style={{ position: "relative", width: "100%", height: "100vh" }}>
      <iframe
        src="/dopamine-nation-summary.html"
        style={{
          position: "fixed",
          top: 0,
          left: 0,
        ...
        title="Dopamine Nation — Full Summary"
      />
      <button
