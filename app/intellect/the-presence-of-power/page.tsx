...
export default function ThePresenceOfPowerPage() {
  const [isBookmarked, setIsBookmarked] = useState(false);
  const bookmarkId = "doc-the-presence-of-power";
  const docTitle = "The Presence of Power";
  ...
  const handleBookmarkToggle = () => {
    ...
    if (isBookmarked) {
      ...
      updated = [
        { id: bookmarkId, label: docTitle, href: "/intellect/the-presence-of-power", lastRead: Date.now() },
        ...bookmarks,
      ];
    }
    localStorage.setItem("colloque_bookmarks", JSON.stringify(updated));
