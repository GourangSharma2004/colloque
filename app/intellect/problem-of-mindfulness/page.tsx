...
export default function ProblemOfMindfulnessPage() {
  const [isBookmarked, setIsBookmarked] = useState(false);
  const bookmarkId = "doc-problem-of-mindfulness";
  const docTitle = "The Problem of Mindfulness";
  ...
  const handleBookmarkToggle = () => {
    ...
    if (isBookmarked) {
      ...
      updated = [
        { id: bookmarkId, label: docTitle, href: "/intellect/problem-of-mindfulness", lastRead: Date.now() },
        ...bookmarks,
      ];
    }
    localStorage.setItem("colloque_bookmarks", JSON.stringify(updated));
