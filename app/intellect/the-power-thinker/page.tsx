...
export default function ThePowerThinkerPage() {
  const [isBookmarked, setIsBookmarked] = useState(false);
  const bookmarkId = "doc-the-power-thinker";
  const docTitle = "The Power Thinker";
  ...
  const handleBookmarkToggle = () => {
    ...
    if (isBookmarked) {
      ...
      updated = [
        { id: bookmarkId, label: docTitle, href: "/intellect/the-power-thinker", lastRead: Date.now() },
        ...bookmarks,
      ];
    }
    localStorage.setItem("colloque_bookmarks", JSON.stringify(updated));
  ...
  return (
    <div style={{ position: "relative", width: "100%", height: "100vh" }}>
      <iframe
        src="/foucault-power-thinker.html"
        style={{
          position: "fixed",
          inset: 0,
          width: "100%",
