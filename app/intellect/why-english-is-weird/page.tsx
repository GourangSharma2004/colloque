...
export default function WhyEnglishIsWeirdPage() {
  const [isBookmarked, setIsBookmarked] = useState(false);
  const bookmarkId = "doc-why-english-is-weird";
  const docTitle = "Why English Is Genuinely Weird";
  ...
  const handleBookmarkToggle = () => {
    ...
    if (isBookmarked) {
      ...
      updated = [
        { id: bookmarkId, label: docTitle, href: "/intellect/why-english-is-weird", lastRead: Date.now() },
        ...bookmarks,
      ];
    }
    localStorage.setItem("colloque_bookmarks", JSON.stringify(updated));
