...
export default function TheOrgasmCurePage() {
  const [isBookmarked, setIsBookmarked] = useState(false);
  const bookmarkId = "doc-the-orgasm-cure";
  const docTitle = "The Orgasm Cure";
  ...
  const handleBookmarkToggle = () => {
    ...
    if (isBookmarked) {
      ...
      updated = [
        { id: bookmarkId, label: docTitle, href: "/intellect/the-orgasm-cure", lastRead: Date.now() },
        ...bookmarks,
      ];
    }
    localStorage.setItem("colloque_bookmarks", JSON.stringify(updated));
