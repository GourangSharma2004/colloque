...
export default function EndOfWorkPage() {
  const [isBookmarked, setIsBookmarked] = useState(false);
  const bookmarkId = "doc-end-of-work-crisis-of-meaning";
  const docTitle = "The End of Work and the Crisis of Meaning";
  ...
  const handleBookmarkToggle = () => {
    ...
    if (isBookmarked) {
      ...
      updated = [
        { id: bookmarkId, label: docTitle, href: "/intellect/end-of-work-crisis-of-meaning", lastRead: Date.now() },
        ...bookmarks,
      ];
    }
    localStorage.setItem("colloque_bookmarks", JSON.stringify(updated));
