...
export default function AreCodersWorthItPage() {
  const [isBookmarked, setIsBookmarked] = useState(false);
  const bookmarkId = "doc-are-coders-worth-it";
  const docTitle = "Are Coders Worth It?";
  ...
  const handleBookmarkToggle = () => {
    ...
    if (isBookmarked) {
      ...
      updated = [
        { id: bookmarkId, label: docTitle, href: "/intellect/are-coders-worth-it", lastRead: Date.now() },
        ...bookmarks,
      ];
    }
    localStorage.setItem("colloque_bookmarks", JSON.stringify(updated));
